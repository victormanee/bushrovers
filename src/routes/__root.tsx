  ...
  return (
    <div className="flex min-h-[70vh] items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <h2 className="mt-4 font-display text-2xl text-cream">Off the trail</h2>
        <p className="mt-2 text-sm text-muted-foreground">
          This page doesn&apos;t exist or has been moved. Head back to base camp.
        </p>
        <div className="mt-6">
          <Link
            to="/"
  ...
  head: () => ({
    meta: [
      ...
      { title: "Bush Rovers — Scout Rover Crew" },
      {
        name: "description",
        content:
          "Bush Rovers is a Scout Rover crew built around adventure, service, leadership and going beyond the impossible.",
      },
      { property: "og:site_name", content: "Bush Rovers" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "theme-color", content: "#14251b" },
    ],
    links: [
