...
//#region node_modules/.nitro/vite/services/ssr/assets/server-avZ5paSH.js
var server_avZ5paSH_exports = /* @__PURE__ */ __exportAll$1({
	a: () => __exportAll,
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-D6-X1aRV.mjs");
...
var manifest = {
	"9403e4d18479aa0600c41fd67767a34658a2a931addec643a0dd7b8de9b608ac": {
		...
		importer: () => import("./public.functions-BwtXzVw5.mjs")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DQVJDyP1.mjs").then((n) => n.t),
...
//#endregion
export { server_avZ5paSH_exports as a, getServerFnById as i, __exportAll as n, createServerFn as r, TSS_SERVER_FUNCTION as t };
